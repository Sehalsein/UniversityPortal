package com.sehalsein.universityportal.FacultyPortalActivity;
...
public class FacultySendFIleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        permissionlistener = new PermissionListener() {
            ...
            public void onPermissionGranted() {
                TedBottomPicker tedBottomPicker = new TedBottomPicker.Builder(FacultySendFIleActivity.this)
...
//                        .setAction("Action", null).show();
    ...
    private void loadImage(String url){
        Glide.with(FacultySendFIleActivity.this).load(url).fitCenter().crossFade(100).into(imageView);
    }
    ...
    public void chooseFile(View view){
        ...
        TedPermission.with(FacultySendFIleActivity.this)
    ...
    private void makeToast(String message){
        Toast.makeText(FacultySendFIleActivity.this,message,Toast.LENGTH_SHORT).show();
    }

    private void viewImage(String URL){
        Intent intent = new Intent(FacultySendFIleActivity.this, ViewImageActivity.class);
