...
public class UniversityViewAllNotification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NODE = getResources().getString(R.string.firebase_databse_node_notification);
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!notificationDetailList.isEmpty()) {
                    ...
                    recyclerView.setAdapter(new NotificationAdapter(notificationDetailList, UniversityViewAllNotification.this));
